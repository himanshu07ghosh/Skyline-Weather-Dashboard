    ...
    <section className={`hero-card ${mood}`}>
      ...
      <div className="hero-grid">
        ...
        <div className="hero-stat">
          ...
          <p className="hero-stat-value">{visibility ? (visibility / 1000).toFixed(1) : '--'} km</p>
        </div>
        <div className="hero-stat">
          <p className="hero-stat-label">Sunrise</p>
          <p className="hero-stat-value">{sys?.sunrise ? formatTime(sys.sunrise, data.timezone) : '--'}</p>
        </div>
        <div className="hero-stat">
          <p className="hero-stat-label">Sunset</p>
          <p className="hero-stat-value">{sys?.sunset ? formatTime(sys.sunset, data.timezone) : '--'}</p>
        </div>
      </div>
    </section>
  )
